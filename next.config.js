...
module.exports = {
  ...
  env: {
    ...
    NEXT_URL: process.env.NODE_ENV == 'development' ? "http://localhost:3008" : "http://tripster.technorthstar.com",
    BASE_URL: 'https://api.test.hotelbeds.com/',
    NEXTAUTH_URL: process.env.NODE_ENV == 'development' ? "http://localhost:3008" : "http://tripster.technorthstar.com",
    // Farooq
