...
module.exports = {
  ...
  env: {
    ...
    NEXT_URL: process.env.NODE_ENV == 'development' ? "http://localhost:3008" : "https://tripster-seven.vercel.app/",
    BASE_URL: 'https://api.test.hotelbeds.com/',
    // http://tripster.technorthstar.com
    NEXTAUTH_URL: process.env.NODE_ENV == 'development' ? "http://localhost:3008" : "https://tripster-seven.vercel.app/",
    // Farooq
   ...
   // apiSecret:'6ebefd079f',
    ...
    LOCAL_AUTH_URL: process.env.NODE_ENV == 'development' ? "http://localhost:3008" : "https://tripster-seven.vercel.app/",
